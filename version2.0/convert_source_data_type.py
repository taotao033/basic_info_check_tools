...
client = pymongo.MongoClient(host="192.168.1.13", port=27017)
col_information_ancient_base = client["person_basic_relathion_delete_post"]["nlp_extract_base_check_person1"]
col_information_ancient_base2 = client["person_basic_relathion_delete_post"]["nlp_extract_base_check_person1_u"]
col_information_ancient_relation = client["person_basic_relathion_delete_post"]["person18k_Rel_new_3_1"]
col_information_ancient_relation2 = client["person_basic_relathion_delete_post"]["person18k_Rel_new_3_1_u"]
